...
function heroBody(props) {
    ...
    return (
        <div>
            {props.title && (
                <h2 className={classNames('p-8','bg-red-100', styles.title ? mapStyles(styles.title) : null)} data-sb-field-path=".title">
                    {props.title}
                </h2>
            )}
            {props.subtitle && (
                <p
                    className={classNames('bg-red-100', 'sm:text-2xl', styles.subtitle ? mapStyles(styles.subtitle) : null, { 'mt-4': props.title })}
